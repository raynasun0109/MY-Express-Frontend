...
function MerchantShipped(){
    ...
    function fetchTranList(id){
        getTranscationFromSameMerchant({merchant_uuid:id.uuid,status:"shipped"})
            .then(res => {
    ...
    return (
        <MerchantLayout>
             <TableContainer className="merchant_tran_shipped_container_bottom">
...
export default MerchantShipped;